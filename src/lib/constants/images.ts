...
const L = {
  ...
  poloBurgundy: local("polo-burgundy-folded.png"),
  poloBeige: local("polo-beige-sand-folded.png"),
  poloStriped: local("polo-striped-navy-white.png"),
  poloContrast: local("polo-contrast-collar-white-navy.png"),
  poloMesh: local("polo-mesh-grey-sports.png"),
  poloRugby: local("polo-rugby-stripe.png"),
  poloZip: local("polo-zip-neck-black.png"),
  poloColorblock: local("polo-colorblock-navy-white.png"),
  poloGrey: local("polo-grey-melange-folded.png"),
  poloOlive: local("polo-olive-green-folded.png"),
  poloTipped: local("polo-tipped-cuff-white-navy.png"),
  poloPocket: local("polo-pocket-navy.png"),
...
export const IMAGES = {
  ...
  products: {
    ...
    poloBurgundy: L.poloBurgundy,
    poloBeige: L.poloBeige,
    poloStriped: L.poloStriped,
    poloContrast: L.poloContrast,
    poloMesh: L.poloMesh,
    poloRugby: L.poloRugby,
    poloZip: L.poloZip,
    poloColorblock: L.poloColorblock,
    poloGrey: L.poloGrey,
    poloOlive: L.poloOlive,
    poloTipped: L.poloTipped,
    poloPocket: L.poloPocket,
    hoodie: L.hoodieGrey,
